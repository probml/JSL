...
def main():
    ...
    dict_figures = {}
    fig, ax = plt.subplots()
    ax.scatter(*estimated_track.T, edgecolors=color_states_est, c="none", s=10)
    ax.set_title(f"Bootstrap Filter MSE: {bf_mse:.2f}")
    dict_figures["bootstrap-filter-trace"] = fig
...
if __name__ == "__main__":
    ...
    dict_figures = main()
    savefig(dict_figures, pad_inches=0, bbox_inches="tight")
    plt.show()